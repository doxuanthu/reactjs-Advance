...
async function findUser(keyRole) {
  const user = await userRef.once("value", function (snapshot) {});
  return user.val()[keyRole];
}
...
// [POST] path: /api/system/categories/new?key={user_key}
